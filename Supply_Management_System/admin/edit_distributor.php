...
<body>
	...
	<section>
		...
		<li>
			<input type="submit" value="Update Distributor" class="submit_button" /> <span class="error_message"> <?php echo $requireErr; ?> </span><span class="confirm_message"> <?php echo $confirmMessage; ?> </span>
		</li>
		</ul>
		</form>
	</section>
