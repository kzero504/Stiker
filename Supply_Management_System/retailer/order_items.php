...
<body>
	...
	<section>
		...
		<table class="table_displayData">
			...
			<tr>
				...
				<td> <div class="idr-2" id="<?php echo "totalPrice".$row_selectProducts['pro_id']; ?>"></div> </td>
			</tr>
			<?php $i++; } ?>
			<tr>
	...
	<script>
		...
		for (let j = 0; j < elements_2.length; j++) {
			const element = elements_2[j];
			const value = parseFloat(element.textContent);
			// console.log(value)
			const formattedValue = new Intl.NumberFormat('id-ID', {
				style: 'currency',
			...
			console.log(formattedValue)
			element.textContent = isNaN(formattedValue) ? 'Rp 0' : formattedValue;
		}
	</script>
</body>
</html>